        ...
        (new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    JSONObject x = new JSONObject(EntityUtils.toString(response.getEntity()));
                    //System.out.println("herehey:::" + x.toString());
                    String eit = (x).optString("identity_token");


                    System.out.println("hello---" + ":" + eit);
